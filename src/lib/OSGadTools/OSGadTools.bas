...
PUBLIC DECLARE FUNCTION  CreateGadgetA (BYVAL kind AS ULONG, BYVAL gad AS Gadget PTR, BYVAL ng AS NewGadget PTR, BYVAL taglist AS TagItem PTR) AS Gadget PTR LIB -30 GadToolsBase (d0,a0,a1,a2)
PUBLIC DECLARE FUNCTION  FreeGadgets (BYVAL gad AS Gadget PTR) LIB -36 GadToolsBase (a0)
PUBLIC DECLARE FUNCTION  GT_SetGadgetAttrsA (BYVAL gad AS Gadget PTR, BYVAL win AS Window PTR, BYVAL req AS Requester PTR, BYVAL taglist AS TagItem PTR) LIB -42 GadToolsBase (a0,a1,a2,a3)
PUBLIC DECLARE FUNCTION  CreateMenusA (BYVAL newmenu AS NewMenu PTR, BYVAL taglist AS TagItem PTR) AS Menu PTR LIB -48 GadToolsBase (a0,a1)
PUBLIC DECLARE FUNCTION  FreeMenus (BYVAL menu AS Menu PTR) LIB -54 GadToolsBase (a0)
PUBLIC DECLARE FUNCTION  LayoutMenuItemsA (BYVAL firstitem AS MenuItem PTR, BYVAL vi AS VOID PTR, BYVAL taglist AS TagItem PTR) AS BOOLEAN LIB -60 GadToolsBase (a0,a1,a2)
PUBLIC DECLARE FUNCTION  LayoutMenusA (BYVAL firstmenu AS Menu PTR, BYVAL vi AS VOID PTR, BYVAL taglist AS TagItem PTR) AS BOOLEAN LIB -66 GadToolsBase (a0,a1,a2)
PUBLIC DECLARE FUNCTION  GT_GetIMsg (BYVAL iport AS MsgPort PTR) AS IntuiMessage PTR LIB -72 GadToolsBase (a0)
PUBLIC DECLARE FUNCTION  GT_ReplyIMsg (BYVAL imsg AS IntuiMessage PTR) LIB -78 GadToolsBase (a1)
PUBLIC DECLARE FUNCTION  GT_RefreshWindow (BYVAL win AS Window PTR, BYVAL req AS Requester PTR) LIB -84 GadToolsBase (a0,a1)
PUBLIC DECLARE FUNCTION  GT_BeginRefresh (BYVAL win AS Window PTR) LIB -90 GadToolsBase (a0)
PUBLIC DECLARE FUNCTION  GT_EndRefresh (BYVAL win AS Window PTR, BYVAL complete AS BOOLEAN) LIB -96 GadToolsBase (a0,d0)
PUBLIC DECLARE FUNCTION  GT_FilterIMsg (BYVAL imsg AS IntuiMessage PTR) AS IntuiMessage PTR LIB -102 GadToolsBase (a1)
PUBLIC DECLARE FUNCTION  GT_PostFilterIMsg (BYVAL imsg AS IntuiMessage PTR) AS IntuiMessage PTR LIB -108 GadToolsBase (a1)
PUBLIC DECLARE FUNCTION  CreateContext (BYVAL glistptr AS Gadget PTR) AS Gadget PTR LIB -114 GadToolsBase (a0)
PUBLIC DECLARE FUNCTION  DrawBevelBoxA (BYVAL rport AS RastPort PTR, BYVAL left AS INTEGER, BYVAL top AS INTEGER, BYVAL width AS INTEGER, BYVAL height AS INTEGER, BYVAL taglist AS TagItem PTR) LIB -120 GadToolsBase (a0,d0,d1,d2,d3,a1)
PUBLIC DECLARE FUNCTION  GetVisualInfoA (BYVAL screen AS Screen PTR, BYVAL taglist AS TagItem PTR) AS VOID PTR LIB -126 GadToolsBase (a0,a1)
PUBLIC DECLARE FUNCTION  FreeVisualInfo (BYVAL vi AS VOID PTR) LIB -132 GadToolsBase (a0)
PUBLIC DECLARE FUNCTION  GT_GetGadgetAttrsA (BYVAL gad AS Gadget PTR, BYVAL win AS Window PTR, BYVAL req AS Requester PTR, BYVAL taglist AS TagItem PTR) AS LONG LIB -174 GadToolsBase (a0,a1,a2,a3)
