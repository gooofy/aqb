...
DECLARE SUB      GTG DRAW BEVEL BOX (_COORD2(BYVAL s1 AS BOOLEAN=FALSE, BYVAL x1 AS INTEGER, BYVAL y1 AS INTEGER, BYVAL s2 AS BOOLEAN=FALSE, BYVAL x2 AS INTEGER, BYVAL y2 AS INTEGER), BYVAL tag AS ULONG, ...)

DECLARE SUB      ON GTG UP   CALL (BYVAL g AS GTGADGET_t PTR, BYVAL cb AS SUB (BYVAL INTEGER, BYVAL INTEGER, BYVAL UINTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
DECLARE SUB      ON GTG DOWN CALL (BYVAL g AS GTGADGET_t PTR, BYVAL cb AS SUB (BYVAL INTEGER, BYVAL INTEGER, BYVAL UINTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
DECLARE SUB      ON GTG MOVE CALL (BYVAL g AS GTGADGET_t PTR, BYVAL cb AS SUB (BYVAL INTEGER, BYVAL INTEGER, BYVAL UINTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
