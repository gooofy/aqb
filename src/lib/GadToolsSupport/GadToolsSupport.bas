...
CLASS GTSLIDER EXTENDS CGTGadget
...
CLASS GTTEXT EXTENDS CGTGadget
...
CLASS GTSCROLLER EXTENDS CGTGadget
...
CLASS GTSTRING EXTENDS CGTGadget
...
CLASS GTINTEGER EXTENDS CGTGadget
...
CLASS GTNUMBER EXTENDS CGTGadget
...
CLASS GTCYCLE EXTENDS CGTGadget
...
CLASS GTPALETTE EXTENDS CGTGadget
...
CLASS GTLISTVIEW EXTENDS CGTGadget
