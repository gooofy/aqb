...
PUBLIC DECLARE EXTERN SUB      GET             (_COORD2(BYVAL s1 AS BOOLEAN=FALSE, BYVAL x1 AS INTEGER=-1, BYVAL y1 AS INTEGER=-1, BYVAL s2 AS BOOLEAN=FALSE, BYVAL x2 AS INTEGER=-1, BYVAL y2 AS INTEGER=-1), BYVAL blit AS VOID PTR)
PUBLIC DECLARE EXTERN SUB      PUT             (_COORD(BYVAL s AS BOOLEAN=FALSE, BYVAL x AS INTEGER=-1, BYVAL y AS INTEGER=-1), BYVAL blit AS VOID PTR, BYVAL minterm AS UBYTE=&HC0, _
...
PUBLIC DECLARE EXTERN SUB      ON WINDOW CLOSE CALL   (BYVAL wid AS INTEGER, BYVAL p AS SUB (BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
PUBLIC DECLARE EXTERN SUB      ON WINDOW NEWSIZE CALL (BYVAL wid AS INTEGER, BYVAL p AS SUB (BYVAL INTEGER, BYVAL INTEGER, BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
PUBLIC DECLARE EXTERN SUB      ON WINDOW REFRESH CALL (BYVAL wid AS INTEGER, BYVAL p AS SUB (BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
...
PUBLIC DECLARE EXTERN SUB      ON MOUSE CALL          (BYVAL p AS SUB (BYVAL INTEGER, BYVAL BOOLEAN, BYVAL INTEGER, BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR=NULL)
...
PUBLIC DECLARE EXTERN SUB      ON MOUSE MOTION CALL   (BYVAL p AS SUB (BYVAL INTEGER, BYVAL BOOLEAN, BYVAL INTEGER, BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR=NULL)
