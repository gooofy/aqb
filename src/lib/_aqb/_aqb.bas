...
PUBLIC DECLARE SUB COLOR (fg AS INTEGER=-1, bg AS INTEGER=-1, o AS INTEGER=-1)

PUBLIC DECLARE SUB AREA (_COORD(s AS BOOLEAN=FALSE, x1 AS INTEGER, y AS INTEGER))
PUBLIC DECLARE SUB AREAFILL (mode AS INTEGER=0)
PUBLIC DECLARE SUB AREA OUTLINE (enabled AS BOOLEAN)
