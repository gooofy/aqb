...
PUBLIC DECLARE SUB      BITMAP MASK     (BYVAL bm AS BITMAP_t PTR)
...
PUBLIC DECLARE SUB      TEXTEXTEND    (BYVAL s AS STRING, BYREF w AS INTEGER, BYREF h AS INTEGER)
...
PUBLIC DECLARE SUB      WINDOW (BYVAL wid AS INTEGER, BYVAL title AS STRING = NULL, _
...
PUBLIC DECLARE SUB      WINDOW CLOSE           (BYVAL wid AS INTEGER = 0)
PUBLIC DECLARE SUB      WINDOW OUTPUT          (BYVAL wid AS INTEGER = 0)
PUBLIC DECLARE SUB      ON WINDOW CLOSE CALL   (BYVAL wid AS INTEGER, BYVAL p AS SUB (BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
PUBLIC DECLARE SUB      ON WINDOW NEWSIZE CALL (BYVAL wid AS INTEGER, BYVAL p AS SUB (BYVAL INTEGER, BYVAL INTEGER, BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
PUBLIC DECLARE SUB      ON WINDOW REFRESH CALL (BYVAL wid AS INTEGER, BYVAL p AS SUB (BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR = NULL)
PUBLIC DECLARE FUNCTION WINDOW                 (BYVAL n AS INTEGER) AS ULONG
PUBLIC DECLARE SUB      MOUSE ON
PUBLIC DECLARE SUB      MOUSE OFF
PUBLIC DECLARE SUB      ON MOUSE CALL          (BYVAL p AS SUB (BYVAL INTEGER, BYVAL BOOLEAN, BYVAL INTEGER, BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR=NULL)
...
PUBLIC DECLARE SUB      ON MOUSE MOTION CALL   (BYVAL p AS SUB (BYVAL INTEGER, BYVAL BOOLEAN, BYVAL INTEGER, BYVAL INTEGER, BYVAL VOID PTR), BYVAL ud AS VOID PTR=NULL)
...
PUBLIC DECLARE SUB      PSET                 (_COORD(BYVAL s AS BOOLEAN=FALSE, BYVAL x AS INTEGER, BYVAL y AS INTEGER), BYVAL c AS INTEGER=-1)
PUBLIC DECLARE FUNCTION POINT                (BYVAL x1 AS INTEGER, BYVAL y AS INTEGER) AS INTEGER
