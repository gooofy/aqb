...
PUBLIC CONST AS INTEGER ERR_PAINT             = 10
PUBLIC CONST AS INTEGER ERR_LINE              = 11
PUBLIC CONST AS INTEGER ERR_PSET              = 12
PUBLIC CONST AS INTEGER ERR_INPUT_OUT_OF_DATA = 13
