...
PUBLIC DECLARE FUNCTION _str2i4_ (BYVAL s AS STRING, l AS INTEGER, b AS INTEGER) AS LONG
PUBLIC DECLARE FUNCTION _str2f_  (BYVAL s AS STRING, l AS INTEGER, b AS INTEGER) AS SINGLE
