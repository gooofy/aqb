...
PUBLIC DECLARE EXTERN FUNCTION HEX$ (BYVAL l AS ULONG    ) AS STRING
PUBLIC DECLARE EXTERN FUNCTION OCT$ (BYVAL l AS ULONG    ) AS STRING
PUBLIC DECLARE EXTERN FUNCTION BIN$ (BYVAL l AS ULONG    ) AS STRING
...
PUBLIC DECLARE EXTERN FUNCTION SPACE$  (BYVAL n AS INTEGER) AS STRING
PUBLIC DECLARE EXTERN FUNCTION SPC     (BYVAL n AS INTEGER) AS STRING
PUBLIC DECLARE EXTERN FUNCTION STRING$ (BYVAL n AS INTEGER, BYVAL s AS STRING) AS STRING

' (dynamic) memory

PUBLIC DECLARE EXTERN FUNCTION ALLOCATE   (BYVAL size AS ULONG, BYVAL flags AS ULONG=0) AS ANY PTR
PUBLIC DECLARE EXTERN SUB      DEALLOCATE (p AS ANY PTR)
...
PUBLIC DECLARE EXTERN SUB      GC RUN
