...
PUBLIC DECLARE EXTERN FUNCTION HEX$ (BYVAL l AS LONG    ) AS STRING
PUBLIC DECLARE EXTERN FUNCTION OCT$ (BYVAL l AS LONG    ) AS STRING
PUBLIC DECLARE EXTERN FUNCTION BIN$ (BYVAL l AS LONG    ) AS STRING
