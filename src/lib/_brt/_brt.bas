...
TYPE _DARRAY_T
    ...
    PUBLIC:
        ...
        DECLARE SUB      REDIM  (BYVAL numDims AS UINTEGER, ...)
        DECLARE FUNCTION IDXPTR (BYVAL dyna AS VOID PTR, BYVAL dimCnt AS UINTEGER, ...) AS VOID PTR
        DECLARE FUNCTION LBOUND (BYVAL dyna AS VOID PTR, BYVAL d AS UINTEGER) AS INTEGER
        DECLARE FUNCTION UBOUND (BYVAL dyna AS VOID PTR, BYVAL d AS UINTEGER) AS INTEGER
