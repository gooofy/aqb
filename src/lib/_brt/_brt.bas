...
PUBLIC DECLARE SUB _debug_puts (BYREF s AS STRING)
...
PUBLIC DECLARE FUNCTION _str2i4_ (BYREF s AS STRING, BYVAL l AS INTEGER, BYVAL b AS INTEGER) AS LONG
PUBLIC DECLARE FUNCTION _str2f_  (BYREF s AS STRING, BYVAL l AS INTEGER, BYVAL b AS INTEGER) AS SINGLE

PUBLIC DECLARE FUNCTION VAL      (BYREF s AS STRING) AS SINGLE
PUBLIC DECLARE FUNCTION VALINT   (BYREF s AS STRING) AS INTEGER
PUBLIC DECLARE FUNCTION VALUINT  (BYREF s AS STRING) AS UINTEGER
PUBLIC DECLARE FUNCTION VALLNG   (BYREF s AS STRING) AS LONG
PUBLIC DECLARE FUNCTION VALULNG  (BYREF s AS STRING) AS ULONG

' string utils

PUBLIC DECLARE FUNCTION len   (BYREF s AS STRING) AS LONG
...
PUBLIC DECLARE SUB _aqb_assert (BYVAL b AS BOOLEAN, BYREF s AS STRING)
