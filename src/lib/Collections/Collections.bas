...
PUBLIC INTERFACE ICollection IMPLEMENTS IEnumerable
    ...
    PUBLIC:
        ...
        DECLARE VIRTUAL PROPERTY Count AS ULONG
...
PUBLIC INTERFACE IList IMPLEMENTS ICollection
    ...
    PUBLIC:
        ...
        DECLARE VIRTUAL FUNCTION GetAt (BYVAL index AS ULONG) AS ANY
        DECLARE VIRTUAL SUB      SetAt (BYVAL index AS ULONG, BYVAL obj AS ANY)
        ...
        DECLARE VIRTUAL FUNCTION Add (BYVAL obj AS ANY) AS ULONG
        ...
        DECLARE VIRTUAL FUNCTION IndexOf (BYVAL value AS ANY) AS ULONG

        ' insert value into the list at position index.
        ' index must be non-negative and less than or equal to the
        ' number of elements in the list.  If index equals the number
        ' of items in the list, then value is appended to the end
        DECLARE VIRTUAL SUB Insert (BYVAL index AS ULONG, BYVAL value AS ANY)

        ' remove an item from the list
        DECLARE VIRTUAL SUB Remove (BYVAL value AS ANY)

        ' remove the item at position index
        DECLARE VIRTUAL SUB RemoveAt (BYVAL index AS ULONG)
...
PUBLIC CLASS ArrayList IMPLEMENTS IList, ICloneable
    ...
    PUBLIC:
        ...
        DECLARE EXTERN CONSTRUCTOR (BYVAL capacity AS ULONG = 0)

        DECLARE EXTERN VIRTUAL PROPERTY Count AS ULONG

        DECLARE EXTERN VIRTUAL PROPERTY Capacity AS ULONG
        DECLARE EXTERN VIRTUAL PROPERTY Capacity (BYVAL c AS ULONG)

        DECLARE EXTERN VIRTUAL FUNCTION GetAt (BYVAL index AS ULONG) AS ANY
        DECLARE EXTERN VIRTUAL SUB      SetAt (BYVAL index AS ULONG, BYVAL obj AS ANY)

        DECLARE EXTERN VIRTUAL FUNCTION GetEnumerator () AS IEnumerator PTR

        DECLARE EXTERN VIRTUAL FUNCTION Clone () AS CObject PTR

        DECLARE EXTERN VIRTUAL FUNCTION Add (BYVAL obj AS ANY) AS ULONG
        ...
        DECLARE EXTERN VIRTUAL FUNCTION IndexOf (BYVAL value AS ANY) AS ULONG

        DECLARE EXTERN VIRTUAL SUB Insert (BYVAL index AS ULONG, BYVAL value AS ANY)

        DECLARE EXTERN VIRTUAL SUB Remove (BYVAL value AS ANY)

        DECLARE EXTERN VIRTUAL SUB RemoveAt (BYVAL index AS ULONG)
