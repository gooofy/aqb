...
{
    fprintf (cstubf, "VOID _%s___%s (%s *THIS)", IR_name2string(tyCls->u.cls.name, /*underscoreSeparator=*/true), methodName, IR_name2string(tyCls->u.cls.name, /*underscoreSeparator=*/true));
