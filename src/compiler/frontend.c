...
static S_symbol defineKeyword (char *s, int8_t pre_indent, int8_t post_indent)
{
    assert (FE_num_keywords<MAX_KEYWORDS);
    S_symbol kw = S_Symbol(s, FALSE);
    FE_keywords[FE_num_keywords] = kw;
    FE_keyword_pre_indents[FE_num_keywords] = pre_indent;
    FE_keyword_post_indents[FE_num_keywords++] = post_indent;
    return kw;
}
...
{
    FE_num_keywords = 0;
    S_DIM             = defineKeyword("DIM", 0, 0);
    S_SHARED          = defineKeyword("SHARED", 0, 0);
    S_AS              = defineKeyword("AS", 0, 0);
    S_PTR             = defineKeyword("PTR", 0, 0);
    S_XOR             = defineKeyword("XOR", 0, 0);
    S_EQV             = defineKeyword("EQV", 0, 0);
    S_IMP             = defineKeyword("IMP", 0, 0);
    S_AND             = defineKeyword("AND", 0, 0);
    S_OR              = defineKeyword("OR", 0, 0);
    S_SHL             = defineKeyword("SHL", 0, 0);
    S_SHR             = defineKeyword("SHR", 0, 0);
    ...
    S_CONST           = defineKeyword("CONST", 0, 0);
    S_SIZEOF          = defineKeyword("SIZEOF", 0, 0);
    S_EXTERN          = defineKeyword("EXTERN", 0, 0);
    S_DECLARE         = defineKeyword("DECLARE", 0, 0);
    S_LIB             = defineKeyword("LIB", 0, 0);
    S_BYVAL           = defineKeyword("BYVAL", 0, 0);
    S_BYREF           = defineKeyword("BYREF", 0, 0);
    S_TYPE            = defineKeyword("TYPE", 0, 0);
    S_VARPTR          = defineKeyword("VARPTR", 0, 0);
    S_WHILE           = defineKeyword("WHILE", 0, 0);
    S_WEND            = defineKeyword("WEND", 0, 0);
    S_LET             = defineKeyword("LET", 0, 0);
    S__COORD2         = defineKeyword("_COORD2", 0, 0);
    S__COORD          = defineKeyword("_COORD", 0, 0);
    S_EXIT            = defineKeyword("EXIT", 0, 0);
    S__LINEBF         = defineKeyword("_LINEBF", 0, 0);
    S_B               = defineKeyword("B", 0, 0);
    S_BF              = defineKeyword("BF", 0, 0);
    S_DO              = defineKeyword("DO", 0, 0);
    S_SELECT          = defineKeyword("SELECT", 0, 0);
    S_CONTINUE        = defineKeyword("CONTINUE", 0, 0);
    S_UNTIL           = defineKeyword("UNTIL", 0, 0);
    S_LOOP            = defineKeyword("LOOP", 0, 0);
    S_CAST            = defineKeyword("CAST", 0, 0);
    S_CASE            = defineKeyword("CASE", 0, 0);
    S_IS              = defineKeyword("IS", 0, 0);
    S_RETURN          = defineKeyword("RETURN", 0, 0);
    S_PRIVATE         = defineKeyword("PRIVATE", 0, 0);
    S_PUBLIC          = defineKeyword("PUBLIC", 0, 0);
    S_IMPORT          = defineKeyword("IMPORT", 0, 0);
    S_STRDOLLAR       = defineKeyword("STR$", 0, 0);
    S_DEFSNG          = defineKeyword("DEFSNG", 0, 0);
    S_DEFLNG          = defineKeyword("DEFLNG", 0, 0);
    S_DEFINT          = defineKeyword("DEFINT", 0, 0);
    S_DEFSTR          = defineKeyword("DEFSTR", 0, 0);
    S_GOSUB           = defineKeyword("GOSUB", 0, 0);
    S_CONSTRUCTOR     = defineKeyword("CONSTRUCTOR", 0, 0);
    S_LBOUND          = defineKeyword("LBOUND", 0, 0);
    S_UBOUND          = defineKeyword("UBOUND", 0, 0);
    S_PROTECTED       = defineKeyword("PROTECTED", 0, 0);
    S__DARRAY_T       = defineKeyword("_DARRAY_T", 0, 0);
    S_REDIM           = defineKeyword("REDIM", 0, 0);
    S_PRESERVE        = defineKeyword("PRESERVE", 0, 0);
    S__ISNULL         = defineKeyword("_ISNULL", 0, 0);
    S_ERASE           = defineKeyword("ERASE", 0, 0);
    S_DATA            = defineKeyword("DATA", 0, 0);
    S_READ            = defineKeyword("READ", 0, 0);
    S_RESTORE         = defineKeyword("RESTORE", 0, 0);
    S_LINE            = defineKeyword("LINE", 0, 0);
    S_INPUT           = defineKeyword("INPUT", 0, 0);
}
