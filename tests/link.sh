...
rm -f foo.s foo.o foo foo.dump foo.asm foo_gnu.o foo_gnu.bin foo_gnu.dump foo.log
...
../target/x86_64-linux/bin/aqb -v -L ../src/lib -d _brt -a foo.s -A foo.S -p foo.o -o foo ${EXAMPLE}.bas || exit
...
echo ${VASM}  foo.s -o foo_vasm.o
${VASM}  foo.S -o foo_vasm.o
